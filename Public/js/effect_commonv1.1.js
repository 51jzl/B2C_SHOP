...
(function($){
    dk_slideplayer = function(object,config){
        ...
        var _this = this;
        var t;
        var defaults = {width:"300px",height:"200px",fontsize:"12px",right:"0px",bottom:"0px",time:"5000"};
        ...
        this.factory = function(){
            ...
            $(this.obj).prepend("<div style='margin-left:40px;margin-bottom:20px;position:absolute;z-index:20;left:"+this.config.right+";bottom:"+this.config.bottom+"'></div>");
            ...
            $(this.obj + " .dkTitleBg").css({position:"absolute",margin:"0",padding:"0",zIndex:"1",bottom:"0",left:"0",width:"100%",height:"16px",background:"#000",opacity:"0.0",overflow:"hidden"})
            //插入标题
        ...
        this.resetclass =function(obj,i){
            $(obj).css({float:"left",marginRight:"5px",width:"16px",height:"17px",lineHeight:"15px",textAlign:"center",fontWeight:"800",fontSize:"0px",color:"#000",background:" url('"+_this.config.path+"web/img/ic5.png') no-repeat scroll 0 0 transparent",cursor:"pointer"});
            $(obj).eq(i).css({background: "url('"+_this.config.path+"web/img/ic4.png') no-repeat scroll 0 0 transparent",display:"inline-block",height:"17px",width:"16px",textDecoration:"none"});
        }
        this.factory();
    }
})(jQuery)
